...
DROP USER 'u895145282_nqb4f'@'localhost';
CREATE USER 'u895145282_nqb4f'@'localhost' IDENTIFIED BY 'S4WNX41oZbDH0p42ecok';
GRANT SELECT,INSERT,UPDATE,DELETE,EXECUTE ON `u895145282_3arsl`.* TO 'u895145282_nqb4f'@'localhost';
